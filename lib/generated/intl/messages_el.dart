...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
          "Το Easy POS είναι μια ολοκληρωμένη επιχειρηματική λύση με αποθήκη, λογαριασμό, πωλήσεις, δαπάνες και απώλειες/κέρδη.",
        ),
        ...
        "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
          "Τα χαρακτηριστικά είναι το σημαντικό μέρος που κάνει το Easy POS διαφορετικό από τις παραδοσιακές λύσεις.",
        ),
        ...
        "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
          "Η εφαρμογή Easy POS είναι δωρεάν και εύκολη στη χρήση. Πράγματι, είναι ένα από τα καλύτερα συστήματα POS σε όλο τον κόσμο.",
        ),
