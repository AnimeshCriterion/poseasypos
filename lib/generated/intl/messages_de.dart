...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
      "ABI POS ist eine komplette Geschäftslösung mit Lagerbestand, Konten, Verkäufen, Ausgaben und Gewinn/Verlust.",
    ),
    ...
    "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
      "Funktionen sind der wichtige Teil, der ABI POS von traditionellen Lösungen unterscheidet.",
    ),
    ...
    "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
      "Die ABI POS App ist kostenlos und einfach zu bedienen. Tatsächlich gehört sie zu den besten POS-Systemen weltweit.",
    ),
