...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
      "ABI POS היא פתרון עסקי מוחלט עם מלאי, חשבונות, מכירות, הוצאות והפסד/רווח.",
    ),
    ...
    "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
      "התכונות הן החלק החשוב שהופך את ABI POS לשונה מהפתרונות המסורתיים.",
    ),
    ...
    "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
      "אפליקציית ABI POS חינמית וקלה לשימוש. למעשה, זו אחת מהמערכות POS הטובות ביותר בעולם.",
    ),
