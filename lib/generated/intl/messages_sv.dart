...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
      "ABI POS je kompletné podnikateľské riešenie so skladom, účtami, predajmi, výdavkami a ziskom/stratou.",
    ),
    ...
    "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
      "Funkcie sú dôležitou časťou, ktorá robí z aplikácie ABI POS niečo iné ako tradičné riešenia.",
    ),
    ...
    "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
      "Aplikácia ABI POS je bezplatná a jednoduchá na používanie. V skutočnosti ide o jednu z najlepších pokladničných systémov na svete.",
    ),
